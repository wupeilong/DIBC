			...
			<div class="" style="width: 300px;margin-bottom: 12em;">
				<form action="" class="bingform">
					<div class="">
						...
						<input type="text" class="border-bottom" name="" id="" value="" placeholder="请输入营业执照编号"/>
					</div>
				...
				<div class="text-center margin-top4">
					<a href="javascript:;" class="btn btn-success form-control" id="confirm_bingding">确定绑定</a>
					<p class="margin-top">绑定账号用以……</p>
				</div>
			</div>
		</main>
		<script type="text/javascript">
			$("#confirm_bingding").click(function(){
				laymsg("绑定成功,即将进入主页")
			})
		</script>
	</body>
